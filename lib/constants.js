export const DATASETS = [
  ...
  {
    "dataset": () => "NCBN",
    "layer1": "Northern and Western European",
    "layer2": "",
    "layer3": "",
    "source": "ncbn.ceu"
  },
...
export const ensureAllDatasets = (frequencies, assembly) => {
  ...
  const datasets = (assembly => {
    switch (assembly) {
      case 'GRCh37':
        return ["gem_j_wga", "jga_ngs", "jga_snp", "tommo", "hgvd", "gnomad_genomes", "gnomad_exomes"];
      case 'GRCh38':
        return ["gem_j_wga", "jga_ngs", "jga_snp", "tommo", "ncbn", "gnomad_genomes", "gnomad_exomes"];
    }
  })(assembly);
